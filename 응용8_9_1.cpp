...
void game_control(char name[][8], int condition[],  int *left, int user, int *s, int *e)//게임제어  
{
	int i, dice_number;
...
void gotoxy(int x, int y)//커서 위치 제 
{
   COORD Pos = {x - 1, y - 1};
